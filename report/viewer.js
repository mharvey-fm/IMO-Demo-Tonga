(function () {
    ...
    var fileHref = encodeURI(stage.dataset.pdf || '');
    var title = stage.dataset.title || 'Inspection report';
    ...
    var downloadEl = document.getElementById('v-download');
    ...
    function showFallback(message) {
        ...
        statusEl.innerHTML =
            ...
            '<iframe class="viewer-embed" title="' + title.replace(/"/g, '') + '" src="' + fileHref + '"></iframe>';
    }
